...
public class Deparment extends College{
	...
	Deparment(String collegeName, int clgYear, int student, String principal,String uniName,int year,int collegeCnt,String vc,String chancellor,String deparment,int stdCount,String HOD,int classes)
	{
